...
1. **Complete mais exercícios** - Cada aula vale 100 pontos
2. **Capriche no código** - Boas práticas aumentam sua nota
3. **Seja criativo** - Bônus para soluções diferenciadas
4. **Entregue no prazo** - Penalização por atraso
5. **Ajude colegas** - Abra Issues, responda dúvidas
